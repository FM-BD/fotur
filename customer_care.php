...
<html>
<head>
    <title>||Customar Care Page||</title>
</head>
<body>
    <table align = "center"   width= 100% >
        ...
        <tr>
			...
			<!-- part for Customer Care page  starts-->

			<td colspan="4">
				<h3 align="center">Customer Care</h3>
				<p align="center">Customer_Care@fotur.com</p>
				<br><br><br><br><br><br><br><br>
			</td>
		</tr>

    		<!-- part for Customer Care page ends -->
		</tr>
		<td colspan="2">
