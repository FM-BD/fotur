	...
	<table align = "center"   width= 100% >
		...
		<tr>
			<td colspan="5">
				...
				<p>
					Welcome to Futur.com also hereby known as  "FUTUR". We are an online marketplace and these are the terms and conditions governing your access and use of Futur along with its related sub-domains, sites, services and tools (the "Site"). By using the Site, you hereby accept these terms and conditions (including the linked information herein) and represent that you agree to comply with these terms and conditions (the "User Agreement"). This User Agreement is deemed effective upon your use of the Site which signifies your acceptance of these terms. If you do not agree to be bound by this User Agreement please do not access, register with or use this Site. This Site is owned and operated by Futur Bangladesh Limited (Registration Number: "XX-XXX-XXX")
				</p>
			</td>
		</tr>
